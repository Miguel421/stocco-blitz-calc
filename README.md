# stocco-blitz-calc
Plataforma de cálculos elétricos para estudantes e profissionais.
...
- Cálculo de tensão (Voltage calculation)
- Cálculo de corrente (Current calculation)
- Cálculo de resistência (Resistance calculation)
- Cálculo de potência aparente (Apparent power calculation)
